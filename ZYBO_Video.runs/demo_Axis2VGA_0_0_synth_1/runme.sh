...
HD_PWD='D:/Project/Vivado/Terminated_project/ZYBO_Video/ZYBO_Video.runs/demo_Axis2VGA_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log demo_Axis2VGA_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source demo_Axis2VGA_0_0.tcl
